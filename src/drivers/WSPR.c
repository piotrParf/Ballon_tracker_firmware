...
void WSPR_transmit(void)
{
  ...
  //  WATCHDOG_restart();														// whole transmission takes 110.6s, watchdog period is only 16s
    ...
    {
      case 0:
        SI5351_MS1_frequency(SI5351_FREQUENCY);							// 0.001 Hz, Tone 0
        break;
      case 1:
        SI5351_MS1_frequency(SI5351_FREQUENCY + 1465);					// 0.001 Hz, Tone 1
        break;
      case 2:
        SI5351_MS1_frequency(SI5351_FREQUENCY + 2930);					// 0.001 Hz, Tone 2
        break;
      case 3:
        SI5351_MS1_frequency(SI5351_FREQUENCY + 4394);					// 0.001 Hz, Tone 3
        break;
      default:
        break;
    }
